...
public class PrometeoCarController : MonoBehaviour
{
    ...
    //PRIVATE VARIABLES
      ...
      */
      ...
      private InputsValue inputsValue;
    ...
    void Start()
    {
      inputsValue = GetComponent<InputsValue>();
    ...
    public void SetProfile(LobbyProfile setup)
    {
    ...
    public void RecoverTraction(){
      ...
      driftingAxis = driftingAxis - (Time.deltaTime / 4f);
      if(driftingAxis < 0f){
        driftingAxis = 0f;
      }
